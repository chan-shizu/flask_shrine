# import Flask and render_template (function to display HTML)
...
# returns the string "Hello World" when "/" is accessed
@app.route("/")
@app.route("/index")
def index():
...
# run app.run() only when app.py is called directoly from the terminal
